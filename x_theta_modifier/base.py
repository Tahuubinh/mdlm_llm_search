...
class XThetaModifier:
    ...
    def __init__(self, num_x_theta_samples, property_type, lower_bound, upper_bound, num_local_searches, tokenizer, top_k_categorical, num_diffusion_steps, data, max_candidate_tokens, vocab_size, mask_index=None):
